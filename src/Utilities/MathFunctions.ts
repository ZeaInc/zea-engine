...
class MathFunctions {
   ...
   */
  static randomInt(min: any, max: any) {
    min = Math.ceil(min)
    max = Math.floor(max)
   ...
   * @return {number} -
   */
  static lerp(v0: any, v1: any, t: any) {
    return v0 + t * (v1 - v0)
  }
   ...
   * @return {number} -
   */
  static remap(value: any, start1: any, end1: any, start2: any, end2: any) {
   ...
   * @return {number} -
   */
  static smoothStep(edge0: any, edge1: any, x: any) {
   ...
   * @return {number} -
   */
  static linStep(edge0: any, edge1: any, x: any) {
   ...
   */
  static decode16BitFloatFrom2xUInt8(c: any) {
   ...
   */
  static encode16BitFloatInto2xUInt8(v: any) {
   ...
   */
  static convertFloat32ArrayToUInt16Array(float32Array: any) {
