...
class Color extends AttrValue {
     ...
     * @param {number} a  - The alpha channel.
     */
    setFromRGB(r: any, g: any, b: any, a: any) {
        this.r = r / 255;
        this.g = g / 255;
        this.b = b / 255;
        this.a = a ? a / 255 : 1.0;
     ...
     */
    setFromCSSColorName(name: any) {
        const colourNameToHex = (colour: any) => {
            const colors = {
                aliceblue: '#f0f8ff',
                antiquewhite: '#faebd7',
                aqua: '#00ffff',
