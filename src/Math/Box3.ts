...
class Box3 {
   ...
   */
  addBox3(box3: any, xfo = undefined) {
    if (xfo) {
  ...
  intersectsSphere(sphere: any) {
    ...
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'closestPoint'.
   ...
   * @private
   */
  loadBin(data: any, byteOffset: any) {
