...
class CalcGeomMatOperator extends Operator {
   ...
   */
  constructor(globalXfoParam: any, geomOffsetXfoParam: any, geomMatParam: any) {
...
class GeomItem extends BaseGeomItem {
  __cleanGeomMat: any;
  __geomMatParam: any;
  __geomOffsetXfoParam: any;
  __geomParam: any;
  __globalXfoParam: any;
  __materialParam: any;
  __paramMapping: any;
  calcGeomMatOperator: any;
  geomIndex: any;
  name: any;
  /**
   ...
   */
  constructor(name: any, geometry = undefined, material = undefined) {
    super(name)
