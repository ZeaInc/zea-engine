...
class Lines extends BaseGeom {
     ...
     */
    setNumSegments(numOfSegments: any) {
     ...
     */
    setSegmentVertexIndices(index: any, p0: any, p1: any) {
     ...
     * @param {number} p1 - The p1 value.
     */
    setSegment(index: any, p0: any, p1: any) {
     ...
     * @private
     */
    getSegmentVertexIndex(line: any, lineVertex: any) {
    ...
    toJSON(context: any) {
        ...
        if (!context || !context.skipTopology)
            (j as any).indices = Array.from(this.__indices);
        return j;
    }
    /**
