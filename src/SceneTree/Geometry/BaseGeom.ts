...
class BaseGeom extends ParameterOwner {
    __boundingBox: any;
    __boundingBoxDirty: any;
    __metaData: any;
    __name: any;
    __numVertices: any;
    __vertexAttributes: any;
    debugColor: any;
    name: any;
    /**
     * Create a base geom.
     ...
     */
    setNumVertices(count: any) {
        this.__numVertices = count;
        // Resizes each of the vertex attributes to match the new count.
        this.__vertexAttributes.forEach((attr: any) => attr.resize(this.__numVertices));
    }
    /**
