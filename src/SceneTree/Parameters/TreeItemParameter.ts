...
class TreeItemParameter extends Parameter {
   ...
   */
  constructor(name: any, filterFn = undefined) {
  ...
  __emittreeItemGlobalXfoChanged(event: any) {
   ...
   */
  setFilterFn() {
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'filterFn'.
    this.__filterFn = filterFn
  }
