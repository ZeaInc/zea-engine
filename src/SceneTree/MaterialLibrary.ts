...
class MaterialLibrary extends EventEmitter {
     ...
     * @return {any} - The return value.
     */
    getMaterial(name: any, assert = true) {
    ...
    readBinary(reader: any, context = {}) {
        ...
        (context as any).lod = this.lod;
        (context as any).materialLibrary = this;
