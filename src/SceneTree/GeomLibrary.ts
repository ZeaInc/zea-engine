...
// @ts-expect-error ts-migrate(2307) FIXME: Cannot find module 'web-worker:./Geometry/GeomPars... Remove this comment to see the full error message
...
class GeomLibrary extends EventEmitter {
   ...
   */
  setGenBufferOption(key: any, value: any) {
   ...
   */
  readBinaryBuffer(key: any, buffer: any, context: any) {
    ...
    if (multiThreadParsing) {
      ...
      // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'parseGeomsBinary'.
      parseGeomsBinary(
        {
          key,
          toc,
   ...
   * @private
   */
  __recieveGeomDatas(key: any, geomDatas: any, geomIndexOffset: any, geomsRange: any) {
