...
class GridTreeItem extends TreeItem {
  ...
  */
 // @ts-expect-error ts-migrate(2345) FIXME: Argument of type '"#DCDCDC"' is not assignable to ... Remove this comment to see the full error message
 constructor(gridSize = 5, resolution = 50, gridColor = new Color('#DCDCDC')) {
   ...
   // @ts-expect-error ts-migrate(2345) FIXME: Argument of type 'Grid' is not assignable to param... Remove this comment to see the full error message
   ...
   // @ts-expect-error ts-migrate(2345) FIXME: Argument of type 'Lines' is not assignable to para... Remove this comment to see the full error message
