...
class BinReader {
   ...
   */
  constructor(data: any, byteOffset = 0, isMobileDevice = true) {
    this.__data = data
   ...
   */
  loadBox2() {
    // @ts-expect-error ts-migrate(2345) FIXME: Argument of type 'Vec2' is not assignable to param... Remove this comment to see the full error message
