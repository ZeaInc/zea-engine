...
class CuttingPlane extends BaseGroup {
  ...
  constructor(name: any) {
    ...
    // @ts-expect-error ts-migrate(2345) FIXME: Argument of type 'Plane' is not assignable to para... Remove this comment to see the full error message
    ...
    // @ts-expect-error ts-migrate(2345) FIXME: Argument of type 'Rect' is not assignable to param... Remove this comment to see the full error message
   ...
   * @private
   */
  __unbindItem(item: any, index: any) {
    if (!(item instanceof TreeItem)) return

    // ///////////////////////////////
    // Update the item cutaway
    item.traverse((treeItem: any) => {
