...
class GLLines extends GLGeom {
   ...
   */
  // @ts-expect-error ts-migrate(2416) FIXME: Property 'genBuffers' in type 'GLLines' is not ass... Remove this comment to see the full error message
  genBuffers(opts: any) {
   ...
   * @param {any} renderstate - The renderstate value.
   */
  // @ts-expect-error ts-migrate(2416) FIXME: Property 'draw' in type 'GLLines' is not assignabl... Remove this comment to see the full error message
