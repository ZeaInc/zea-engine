...
let create3DContext = function(canvas, opt_attribs) {
    ...
    if (context.name == 'webgl2') {
        ...
        context.__ext_half_float = context.getExtension(
    ...
    context.setupInstancedQuad = function() {
        ...
        let vertexIDs = new Float32Array([0.0, 1.0, 2.0, 3.0]);
    ...
    const vertexIDs = new Float32Array([
      0.0,
      1.0
