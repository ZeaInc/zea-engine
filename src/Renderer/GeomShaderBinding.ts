...
class GeomShaderBinding {
   ...
   */
  constructor(gl: any, shaderAttrs: any, glattrbuffers: any, indexBuffer: any) {
    this.__gl = gl
...
function generateShaderGeomBinding(gl: any, shaderAttrs: any, glattrbuffers: any, indexBuffer: any) {
