...
class VRController {
  ...
  __isDaydramController: any;
  __mat4: any;
  __pressedButtons: any;
  __tip: any;
  __touchpadValue: any;
  __treeItem: any;
  __vrviewport: any;
   ...
   */
  constructor(vrviewport: any, inputSource: any, id: any) {
    ...
    if (!this.__isDaydramController) {
      ...
      vrviewport.loadHMDResources().then((asset: any) => {
        asset.on('loaded', () => {
          ...
          controllerTree.getParameter('LocalXfo').setValue(
            new Xfo(
              ...
              // @ts-expect-error ts-migrate(2345) FIXME: Argument of type '{ setFromAxisAndAngle: (number |... Remove this comment to see the full error message
