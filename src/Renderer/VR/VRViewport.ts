...
class VRViewport extends GLBaseViewport {
    __cameraMatrices: any;
    __canPresent: any;
    __far: any;
    __hmd: any;
    __hmdAssetPromise: any;
    __hmdCanvasSize: any;
    __leftProjectionMatrix: any;
    __leftViewMatrix: any;
    __near: any;
    __projectionMatrices: any;
    __projectionMatriciesUpdated: any;
    __refSpace: any;
    __region: any;
    __rightProjectionMatrix: any;
    __rightViewMatrix: any;
    __session: any;
    __stageMatrix: any;
    __stageScale: any;
    __stageTreeItem: any;
    ...
    __vrAsset: any;
    __vrControllers: any;
    __vrControllersMap: any;
    __vrDisplay: any;
    __vrhead: any;
    capturedElement: any;
    renderGeomDataFbo: any;
    /**
    ...
    loadHMDResources() {
        ...
        this.__hmdAssetPromise = new Promise((resolve, reject) => {
            ...
            const sceneSet = (event: any) => {
                ...
                const hmdAssetId = (resourceLoader as any).resolveFilePathToId(assetPath);
            ...
            const __startPresenting = () => {
                (navigator as any).xr
                    ...
                    session.updateRenderState({
                        // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'XRWebGLLayer'.
                    ...
                    session
                        ...
                        return session.requestReferenceSpace('viewer').then((refSpace: any) => {
                            ...
                            // adult human.)
                            // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'XRRigidTransform'.
     ...
     * @private
     */
    __createController(id: any, inputSource: any) {
        ...
        // @ts-expect-error ts-migrate(2552) FIXME: Cannot find name 'vrController'. Did you mean 'con... Remove this comment to see the full error message
        return vrController;
    }
    /**
    ...
    draw(xrFrame: any) {
        ...
        (renderstate as any).viewXfo = this.__vrhead.getTreeItem().getParameter('GlobalXfo').getValue();
        (renderstate as any).viewScale = 1.0 / this.__stageScale;
        (renderstate as any).cameraMatrix = (renderstate as any).viewXfo.toMat4();
        renderstate.region = this.__region;
        (renderstate as any).vrPresenting = true; // Some rendering is ajusted slightly in VR. e.g. Billboards
        ...
        const data = {
            interfaceType: 'VR',
            hmd: this.__hmd,
            viewXfo: (renderstate as any).viewXfo,
