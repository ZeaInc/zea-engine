...
function radicalInverse_VdC(i: any) {
  bits[0] = i
...
function hammersley(i: any, n: any) {
  return [i / n, radicalInverse_VdC(i)]
}

function hemisphereSample_uniform(u: any, v: any, vec3: any) {
...
function hemisphereSample_cos(u: any, v: any, vec3: any) {
  let phi = v * 2.0 * Math.PI
...
function sphereSample_uniform(u: any, v: any, vec3: any) {
  let phi = v * 2.0 * Math.PI
