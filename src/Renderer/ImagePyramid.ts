...
const Math_log2 = function (value: any) {
...
class ImagePyramid extends GLImageAtlas {
   ...
   */
  constructor(gl: any, name: any, srcGLTex: any, destroySrcImage = true, minTileSize = 16) {
    super(gl, name)
   ...
   */
  // @ts-expect-error ts-migrate(2416) FIXME: Property 'generateAtlasLayout' in type 'ImagePyram... Remove this comment to see the full error message
