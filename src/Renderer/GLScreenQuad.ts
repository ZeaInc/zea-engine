...
class GLScreenQuad {
   ...
   */
  constructor(gl: any, preproc: any) {
    this.__gl = gl
   ...
   */
  bind(renderstate: any, texture: any, pos = undefined, size = undefined) {
   ...
   * @param {any} size - The size value.
   */
  draw(renderstate: any, texture: any, pos = undefined, size = undefined) {
