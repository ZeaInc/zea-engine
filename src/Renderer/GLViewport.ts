...
class GLViewport extends GLBaseViewport {
  ...
  __frustumDim: any;
  __gamma: any;
  __geomDataBuffer: any;
  __geomDataBufferFbo: any;
  __geomDataBufferInvalid: any;
  __intersectionData: any;
  __name: any;
  __prevDownTime: any;
  __projectionMatrix: any;
  __screenPos: any;
  __tonemap: any;
  __viewMat: any;
  capturedItem: any;
   ...
   */
  constructor(renderer: any, name: any, width: any, height: any) {
    super(renderer)
    this.__name = name
    ...
    // @ts-expect-error ts-migrate(2345) FIXME: Argument of type '"DefaultCamera"' is not assignab... Remove this comment to see the full error message
   ...
   */
  setManipulator(manipulator: any) {
   ...
   */
  setActive(state: any) {
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'activeViewport'.
   ...
   */
  calcRayFromScreenPos(screenPos: any) {
   ...
   */
  createGeomDataFbo(floatGeomBuffer: any) {
   ...
   */
  getGeomDataAtPos(screenPos: any, pointerRay: any) {
    if (this.__geomDataBufferFbo) {
   ...
   */
  getGeomItemsInRect(tl: any, br: any) {
   ...
   * @private
   */
  __getPointerPos(rendererX: any, rendererY: any) {
   ...
   * @private
   */
  __preparePointerEvent(event: any) {
    event.viewport = this
   ...
   */
  // @ts-expect-error ts-migrate(2416) FIXME: Property 'onKeyDown' in type 'GLViewport' is not a... Remove this comment to see the full error message
  onKeyDown(event: any) {
    this.__preparePointerEvent(event)
    if (this.manipulator) {
   ...
   * @param {KeyboardEvent} event - The event that occurs.
   */
  // @ts-expect-error ts-migrate(2416) FIXME: Property 'onKeyUp' in type 'GLViewport' is not ass... Remove this comment to see the full error message
  onKeyUp(event: any) {
    this.__preparePointerEvent(event)
    if (this.manipulator) {
   ...
   * @private
   */
  __initRenderState(renderstate: any) {
