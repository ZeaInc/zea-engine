...
class GLFbo {
   ...
   */
  constructor(gl: any, colorTexture: any, createDepthTexture = false) {
   ...
   */
  setColorTexture(colorTexture: any) {
    this.__colorTexture = colorTexture
    // @ts-expect-error ts-migrate(2304) FIXME: Cannot find name 'gl'.
   ...
   */
  bindForWriting(renderstate: any) {
    if (renderstate) {
