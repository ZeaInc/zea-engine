...
class GLMesh extends GLGeom {
  ...
  __hardEdgesVao: any;
  __indexDataType: any;
  __numEdgeIndices: any;
  __numRenderVerts: any;
  __numTriIndices: any;
  __numTriangles: any;
  __numVertices: any;
  __numWireIndices: any;
  __vao: any;
  __wireframesVao: any;
  /**
   * Create a GL mesh.
   ...
   * @return {any} - The return value.
   */
  bindWireframeVAO(renderstate: any) {
   ...
   * @return {any} - The return value.
   */
  bindHardEdgesVAO(renderstate: any) {
