...
class GLGeomItem extends EventEmitter {
  ...
  id: any;
  modelMatrixArray: any;
  supportInstancing: any;
  visible: any;
  /**
   ...
   */
  constructor(gl: any, geomItem: any, glGeom: any, id: any, supportInstancing = false) {
    super()
    this.gl = gl
