...
###1. Definitions.  In this Agreement:
	...
	"Software" means the Zea compiled JavaScript, binary or bytecode software program (excluding Third Party Software) that is made available to You after agreeing to the terms of this Agreement. Also referred to as a Software Development Kit (SDK) on our website.
